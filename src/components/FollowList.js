...
class FollowList extends Component {
	...
	async dataPull(){
    	...
    	console.log('FollowList.js dataPull() this.searchState:', this.searchState);
    	var request = await new DBOps().searchUser(JSON.stringify(this.searchState)).catch((err)=>{console.log(err)});
    	console.log('FollowList.js dataPull() request:', request);
    	...
    	console.log('FollowList.js dataPull() this.state.list:', this.state.list);
  	...
  	async initialPull() {
    	...
    	new DBOps().searchUser(JSON.stringify(this.searchState))
      		.catch((err)=>{
        		console.log('FollowList.js initialPull() follow list error:', err);
      		})
      		.then((res)=>{
        		console.log('FollowList.js initialPull() res:', res);
        		var followNum = 0;
        		var followingNum = 0;
  	...
  	handleFollowerClick(){
    	console.log('FollowList.js handleFollowerClick() called');
  	...
  	render(){
    	...
    	if(type === 'initial' && this.props.username){
      		console.log('FollowList.js render() this.props.username:', this.props.username);
      		this.initialPull();
    	}
